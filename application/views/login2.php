...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
      <p class="login-box-msg">Sign in to Resepsionis Page</p>

      <form action="<?php echo base_url('login_res/aksi_login');?>" method="post">
      ...
      <p class="mt-2 mb-3">
        <a href="<?php echo base_url('login_admin');?>" class="text-center">Sign In Admin</a>
      </p>
    </div>
    <!-- /.card-body -->
  </div>
