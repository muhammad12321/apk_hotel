    ...
    <section class="content">
      <div class="container-fluid">
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="<?php echo base_url('kamar/ubah_aksi');?>" method="post" class="form-horizontal" enctype="multipart/form-data">
  <input type="hidden" name="id_kamar" value="<?php echo $entry[0]['id_kamar']?>">
                <div class="card-body">
                  <div class="form-group">
                    <label>Tipe Kamar</label>
                    <input type="text" class="form-control" name="tipe_kamar" value="<?php echo $entry[0]['tipe_kamar']?>">
                  </div>
                  <div class="form-group">
                    <label>Jumlah Kamar</label>
                    <input type="number" class="form-control" name="jml_kamar" value="<?php echo $entry[0]['jml_kamar']?>">
                  </div>
