          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Data fasilitas hotel</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <div class="table-responsive">
                <a href="hotel/tambah" class="btn btn-secondary btn-icon-split right">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <a href="hotel/edit/<?php echo $f->id?>" class="btn btn-primary btn-circle">
                              <i class="fa fa-edit"></i>
                        </a>
                        <a href="hotel/edit2/<?php echo $f->id?>" class="btn btn-primary btn-circle">
                              <i class="fa fa-image"></i>
                        </a> 
                        <a href="hotel/hapus/<?php echo $f->id?>" class="btn btn-danger btn-circle" onclick="return confirm('hapus data?')">
