    ...
    <section class="content">
      <div class="container-fluid">
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="<?php echo base_url('kamar2/tambah_aksi');?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <label>tipe kamar</label>
        <select class="form-control" name="id_kamar" >
          <?php foreach ($f_kamar as $key): ?>
              <option value="<?php echo $key->id_kamar ?>"><?php echo $key->tipe_kamar ?></option>
          <?php endforeach ?>
        </select>
                  </div>
                  <div class="form-group">
