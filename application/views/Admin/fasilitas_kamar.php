          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <a href="kamar2/tambah" class="btn btn-secondary btn-icon-split right">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <?php
                    foreach ($f_kamar as $k2) {
                    ?>
                  <tbody>
                    <tr>
                      <td><?php echo $k2->tipe_kamar;?></td>
                      <td><?php echo $k2->nama_fasilitas;?></td>
                      <td>
                        <a href="kamar2/edit/<?php echo $k2->id?>" class="btn btn-primary">
                              <i class="fa fa-edit"></i>
                        </a> 
                        <a href="kamar2/hapus/<?php echo $k2->id?>" class="btn btn-danger btn-circle" onclick="return confirm('hapus data?')">
